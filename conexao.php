...
$pass = "ProgWeb3";
$db = "progweb3"; // É necessário criar um banco de dados, no phpmyadmin, com o nome progweb3 e, após isso, importar o arquivo progweb3.sql, que criará as tabelas e valores necessários
